...
on `:root` in `assets/css/site.css`. Change a token there and it updates
...
The repo root is already a deployable site. In **Settings → Pages**, set
_Source_ to **Deploy from a branch**, branch `main`, folder `/ (root)`.
